...
export default function ExercisePage() {
  ...
  console.log(`[routes/exercise.tsx] Rendering with lang: ${currentLang}`); // Simplified log

  return (
    <>
      <Head>
        {/* Access t.value directly here */}
        <title>{t.value.record} {t.value.exercise} - {appName}</title>
      </Head>
      {/* Add Header */}
      <Header />
      ...
      <div class="container mx-auto p-4 mt-4 space-y-8">
        ...
        <PageTitle titleKey={["record", "exercise"]} />
        <ExerciseForm />
        <ExerciseList />
      </div>
    </>
